...
#include "caffe/filler.hpp"					// from .cpp of bittnt repo, unsure if needed explicitly
#include "caffe/util/im2col.hpp"			// dito
#include "caffe/util/tvg_util.hpp"			// dito
#include "caffe/util/math_functions.hpp"	// dito

#include "caffe/util/modified_permutohedral.hpp"	// added
#include "caffe/layers/softmax_layer.hpp"			// added
#include "caffe/layers/eltwise_layer.hpp"			// added
#include "caffe/layers/split_layer.hpp"				// added
#include <boost/shared_array.hpp>					// added
